...
from Stage2_detection import config_retinanet as cfg
from Stage2_detection.dataset_bhx import BHXDetectionDataset, detection_collate_fn
from Stage2_detection.model_resnet18_retinanet import build_resnet18_retinanet
...
def main():
    ...
    model = build_resnet18_retinanet(
